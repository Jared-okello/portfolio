...
const educationData: EducationEntry[] = [
  {
    ...
    period: "2021 - 2025",
    details:
      "Relevant coursework: Advanced Programming, Data Structures & Algorithms, Web Development, Software Engineering, Database Systems, Computer Networks, Artificial Intelligence",
  },
];
...
const certificationsData: Certification[] = [
  ...
  { name: "React Developer", issuer: "Scrimba" },
